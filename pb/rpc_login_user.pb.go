...
func (x *LoginUserResponse) GetAccessTokenExpireTime() *timestamppb.Timestamp {
	if x != nil {
...
func (x *LoginUserResponse) GetRefreshTokenExpireTime() *timestamppb.Timestamp {
	if x != nil {
...
const file_rpc_login_user_proto_rawDesc = "" +
	...
	"\faccess_token\x18\x02 \x01(\tR\vaccessToken\x12S\n" +
	"\x18access_token_expire_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x15accessTokenExpireTime\x12\x1c\n" +
	"\x04user\x18\x04 \x01(\v2\b.pb.UserR\x04user\x12#\n" +
	"\rrefresh_token\x18\x05 \x01(\tR\frefreshToken\x12U\n" +
	"\x19refresh_token_expire_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x16refreshTokenExpireTimeB\x11Z\x0fTeslaCoil196/pbb\x06proto3"
...
var file_rpc_login_user_proto_depIdxs = []int32{
	2, // 0: pb.LoginUserResponse.access_token_expire_time:type_name -> google.protobuf.Timestamp
	3, // 1: pb.LoginUserResponse.user:type_name -> pb.User
	2, // 2: pb.LoginUserResponse.refresh_token_expire_time:type_name -> google.protobuf.Timestamp
